...
use_case: "Use when you need a live server's actual CORS response headers for a specific origin. Use it to diagnose browser-blocked requests, verify a fresh deploy, or audit an API permits cross-origin calls — all payable with USDC via x402 without an account."
category: devtools
