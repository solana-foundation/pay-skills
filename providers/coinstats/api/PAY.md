...
- For wallet data, call `/wallet/blockchains` first to get supported chain names, then use `/wallet/balance` for a single chain or `/wallet/balances` for multi-chain aggregation.
